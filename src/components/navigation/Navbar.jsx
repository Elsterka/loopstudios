...
const Navbar = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div
        className={`fixed inset-y-0 left-0 w-full bg-black text-white transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full"
          } z-50`}
      >
