...
import UseWindowSize from "./navigation/UseWindowSize";
  ...
  return (
    <div className="bg-white text-black md:px-25 font-bodyfont ">
      <div className="flex items-cnter justify-center md:justify-between  md:mb-20">
        ...
        <button className="hidden md:flex border-1 px-8 py-2 tracking-wider text-sm hover:bg-purple-900 hover:text-white cursor-pointer">
          SEE ALL
        </button>
      </div>
      <div className="">
          ...
          {products.map((item) => {
            return (
              <div
                ...
                style={{
                  backgroundImage: `url(${isMobile ? item.mobimageUrl : item.deskimageUrl
                    })`,
